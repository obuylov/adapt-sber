(function($) {
  ...
  Dragging.prototype.move = function(e) {
    ...
    var el = this.handle || this.el
    //var zoom=parseFloat(document.getElementById('container').style.zoom)//added by nayan to browser scale;
    var zoom=parseFloat(document.querySelector('[data-id="innerWrapper"]').getAttribute("zoom"))||1//added by nayan to browser scale;
    translate(el[0], deltaX/zoom, deltaY/zoom)
  }
